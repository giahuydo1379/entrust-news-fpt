                            ...
                            <div class="dropdown-menu mega-dropdown-menu">
                                <div class="row">
                                    <div class="col-sm-4 col-md-3">
                                        ...
                                        <ul class="list-unstyled">
                                            <li class="dropdown-header">
                                                <i class="demo-pli-file icon-lg icon-fw"></i> Pages</li>
                                            <li>
                                                <a href="#">Profile</a>
                                            </li>
                                            <li>
                                    ...
                                    <div class="col-sm-4 col-md-3">
                                        ...
                                        <ul class="list-unstyled">
                                            <li class="dropdown-header">
                                                <i class="demo-pli-mail icon-lg icon-fw"></i> Mailbox</li>
                                            <li>
                                                <a href="#">
                                        ...
                                        <p class="pad-top text-main text-sm text-uppercase text-bold">
                                            <i class="icon-lg demo-pli-calendar-4 icon-fw"></i>News</p>
                                    ...
                                    <div class="col-sm-12 col-md-3">
                                        <p class="dropdown-header">
                                            <i class="demo-pli-file-jpg icon-lg icon-fw"></i> Gallery</p>
                                        <div class="row img-gallery">
                                            <div class="col-xs-4">
                                                <img class="admin_assets/img-responsive" src="admin_assets/img/thumbs/img-1.jpg" alt="thumbs">
                                            </div>
                                            <div class="col-xs-4">
                                                <img class="admin_assets/img-responsive" src="admin_assets/img/thumbs/img-3.jpg" alt="thumbs">
                                            </div>
                                            <div class="col-xs-4">
                                                <img class="admin_assets/img-responsive" src="admin_assets/img/thumbs/img-2.jpg" alt="thumbs">
                                            </div>
                                            <div class="col-xs-4">
                                                <img class="admin_assets/img-responsive" src="admin_assets/img/thumbs/img-4.jpg" alt="thumbs">
                                            </div>
                                            <div class="col-xs-4">
                                                <img class="admin_assets/img-responsive" src="admin_assets/img/thumbs/img-6.jpg" alt="thumbs">
                                            </div>
                                            <div class="col-xs-4">
                                                <img class="admin_assets/img-responsive" src="admin_assets/img/thumbs/img-5.jpg" alt="thumbs">
                                            </div>
                                        </div>
                                    ...
                                    <div class="nano-content">
                                        <ul class="head-list">
                                            ...
                                            <li>
                                                <a class="media" href="#">
                                                    <div class="media-left">
                                                        <img class="admin_assets/img-circle img-sm" alt="Profile Picture" src="admin_assets/img/profile-photos/9.png">
                                                    </div>
                                                    <div class="media-body">
                                            ...
                                            <li>
                                                <a class="media" href="#">
                                                    <div class="media-left">
                                                        <img class="admin_assets/img-circle img-sm" alt="Profile Picture" src="admin_assets/img/profile-photos/3.png">
                                                    </div>
                                                    <div class="media-body">
